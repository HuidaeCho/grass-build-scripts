...
#
# To cross-build the latest:
# /usr/local/src/grass-build-scripts/crossbuild.sh /usr/local/src/grass
#
# To cross-build the latest and copy it to ~/archive and /www/software:
# /usr/local/src/grass-build-scripts/crossbuild.sh /usr/local/src/grass
#	~/archive /www/software
#
# To cross-build the latest and copy it to ~/archive and /www/software, but
...
if [ $# -lt 1 ]; then
	echo "Usage: crossbuild.sh /path/to/grass/source [/deploy/path1 /deploy/paty2 ...]"
	exit 1
fi
